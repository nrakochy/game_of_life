...
(function($opal) {
  ...
  $opal.add_stubs(['$require_relative', '$attr_reader', '$each', '$introduce_life_into_the_world', '$<=', '$entropy_tick_to_next_generation_of_life', '$+', '$create_living_cell', '$<<', '$count', '$bring_to_life_all_eligible_neighbors', '$keep_if', '$cell_lives_another_generation?', '$count_number_of_living_neighbors', '$stays_alive?', '$comes_to_life?', '$identify_living_neighbors_of_cell', '$number_of_living_neighbors', '$find_all_possible_neighbors', '$find_living_coordinate', '$include?', '$find_all_coordinates_of_the_living', '$!', '$uniq', '$identify_all_possible_dead_neighbors_of_the_living_world', '$dead_cell_comes_to_life?', '$new']);
  ;
  ;
  self.$require_relative("living_cell_coordinate");
  self.$require_relative("dead_cell_rules");
  self.$require_relative("living_cell_rules");
  return (function($base, $super) {
    function $World(){};
    ...
    def.living_world = nil;
    self.$attr_reader("living_world");

    $opal.cdecl($scope, 'END_OF_THE_WORLD', 50000);

    def.$play_the_game_of_life = function() {
      var $a, $b, TMP_1, $c, self = this, life_cycles = nil, starting_point = nil;

      life_cycles = 0;
      starting_point = [[1, 2], [1, 1], [2, 2], [2, 1]];
      ($a = ($b = starting_point).$each, $a._p = (TMP_1 = function(coordinate){var self = TMP_1._s || this;
if (coordinate == null) coordinate = nil;
      return self.$introduce_life_into_the_world(coordinate)}, TMP_1._s = self, TMP_1), $a).call($b);
      while (life_cycles['$<=']((($c = $scope.END_OF_THE_WORLD) == null ? $opal.cm('END_OF_THE_WORLD') : $c))) {
      self.$entropy_tick_to_next_generation_of_life();
      life_cycles = life_cycles['$+'](1);};
    };

    def.$create_empty_world = function() {
      var self = this;
    ...
    def.$introduce_life_into_the_world = function(living_cell_coordinate) {
      var self = this, living_cell = nil;

      living_cell = self.$create_living_cell(living_cell_coordinate);
      self.living_world['$<<'](living_cell);
      return living_cell;
    };

    def.$count_the_living = function() {
      var self = this;

      return self.living_world.$count();
    };

    def.$entropy_tick_to_next_generation_of_life = function() {
      var $a, $b, TMP_2, $c, TMP_3, self = this, new_life_to_dead_cells = nil;

      new_life_to_dead_cells = self.$bring_to_life_all_eligible_neighbors();
      ($a = ($b = self.living_world).$keep_if, $a._p = (TMP_2 = function(living_cell){var self = TMP_2._s || this;
if (living_cell == null) living_cell = nil;
      return self['$cell_lives_another_generation?'](living_cell)}, TMP_2._s = self, TMP_2), $a).call($b);
      ($a = ($c = new_life_to_dead_cells).$each, $a._p = (TMP_3 = function(living_cell){var self = TMP_3._s || this;
        if (self.living_world == null) self.living_world = nil;
if (living_cell == null) living_cell = nil;
      return self.living_world['$<<'](living_cell)}, TMP_3._s = self, TMP_3), $a).call($c);
      return self.living_world;
    };

    def['$cell_lives_another_generation?'] = function(living_cell) {
      var $a, self = this, living_neighbor_count = nil;

      living_neighbor_count = self.$count_number_of_living_neighbors(living_cell);
      return (($a = $scope.LivingCellRules) == null ? $opal.cm('LivingCellRules') : $a)['$stays_alive?'](living_neighbor_count);
    };

    def['$dead_cell_comes_to_life?'] = function(dead_cell) {
      var $a, self = this, living_neighbor_count = nil;

      living_neighbor_count = self.$count_number_of_living_neighbors(dead_cell);
      return (($a = $scope.DeadCellRules) == null ? $opal.cm('DeadCellRules') : $a)['$comes_to_life?'](living_neighbor_count);
    };

    def.$count_number_of_living_neighbors = function(cell) {
      var self = this, living_neighbors = nil;

      living_neighbors = self.$identify_living_neighbors_of_cell(cell);
      return self.$number_of_living_neighbors(living_neighbors);
    };

    def.$identify_living_neighbors_of_cell = function(living_cell) {
      var $a, $b, TMP_4, self = this, living_neighbors = nil, all_possible_neighbors = nil;

      living_neighbors = [];
      all_possible_neighbors = living_cell.$find_all_possible_neighbors();
      ($a = ($b = self.living_world).$each, $a._p = (TMP_4 = function(cell_from_the_living_world){var self = TMP_4._s || this, $a, cell_location = nil;
if (cell_from_the_living_world == null) cell_from_the_living_world = nil;
      cell_location = cell_from_the_living_world.$find_living_coordinate();
        if ((($a = all_possible_neighbors['$include?'](cell_location)) !== nil && (!$a._isBoolean || $a == true))) {
          return living_neighbors['$<<'](cell_from_the_living_world)
          } else {
          return nil
    ...
    def.$number_of_living_neighbors = function(living_neighbors) {
      var self = this;

      return living_neighbors.$count();
    };

    def.$identify_all_possible_dead_neighbors_of_the_living_world = function() {
      var $a, $b, TMP_5, self = this, all_possible_neighbors = nil, cell_set_of_neighbors = nil, living_coordinates = nil;

      all_possible_neighbors = [];
      cell_set_of_neighbors = [];
      living_coordinates = self.$find_all_coordinates_of_the_living();
      ($a = ($b = self.living_world).$each, $a._p = (TMP_5 = function(living_cell){var self = TMP_5._s || this, $a, $b, TMP_6;
if (living_cell == null) living_cell = nil;
      cell_set_of_neighbors = living_cell.$find_all_possible_neighbors();
        return ($a = ($b = cell_set_of_neighbors).$each, $a._p = (TMP_6 = function(potential_neighbor){var self = TMP_6._s || this, $a;
if (potential_neighbor == null) potential_neighbor = nil;
        if ((($a = living_coordinates['$include?'](potential_neighbor)['$!']()) !== nil && (!$a._isBoolean || $a == true))) {
            return all_possible_neighbors['$<<'](potential_neighbor)
            } else {
            return nil
          }}, TMP_6._s = self, TMP_6), $a).call($b);}, TMP_5._s = self, TMP_5), $a).call($b);
      return all_possible_neighbors.$uniq();
    };

    def.$bring_to_life_all_eligible_neighbors = function() {
      var $a, $b, TMP_7, self = this, new_life_to_dead_cells = nil, all_possible_neighbors = nil;

      new_life_to_dead_cells = [];
      all_possible_neighbors = self.$identify_all_possible_dead_neighbors_of_the_living_world();
      ($a = ($b = all_possible_neighbors).$each, $a._p = (TMP_7 = function(dead_cell){var self = TMP_7._s || this, $a, potential_life = nil;
if (dead_cell == null) dead_cell = nil;
      potential_life = self.$create_living_cell(dead_cell);
        if ((($a = self['$dead_cell_comes_to_life?'](potential_life)) !== nil && (!$a._isBoolean || $a == true))) {
          return new_life_to_dead_cells['$<<'](potential_life)
          } else {
          return nil
        };}, TMP_7._s = self, TMP_7), $a).call($b);
      return new_life_to_dead_cells;
    };

    def.$find_all_coordinates_of_the_living = function() {
      var $a, $b, TMP_8, self = this, coordinates_of_the_living = nil;

      coordinates_of_the_living = [];
      ($a = ($b = self.living_world).$each, $a._p = (TMP_8 = function(living_cell){var self = TMP_8._s || this;
if (living_cell == null) living_cell = nil;
      return coordinates_of_the_living['$<<'](living_cell.$find_living_coordinate())}, TMP_8._s = self, TMP_8), $a).call($b);
      return coordinates_of_the_living;
    };

    return (def.$create_living_cell = function(cell_coordinate) {
      var $a, self = this;

      return (($a = $scope.LivingCellCoordinate) == null ? $opal.cm('LivingCellCoordinate') : $a).$new(cell_coordinate);
    }, nil) && 'create_living_cell';
  })(self, null);
})(Opal);

//# sourceMappingURL=/__opal_source_maps__/game_of_life.js.map
;
